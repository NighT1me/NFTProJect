...
const routes: Array<RouteRecordRaw> = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: '/index-en',
        name: 'Index-en',
        component: () => import(/* webpackChunkName: "index" */ '../views/index-en'),
      },
      {
        path: '/series-en',
        name: 'Series-en',
        component: () => import(/* webpackChunkName: "series" */ '../views/series-en'),
      },
      {
        path: '/fashion-en',
        name: 'Fashion-en',
        component: () => import(/* webpackChunkName: "fashion" */ '../views/fashion-en'),
      },
      {
        path: '/creator-en',
        name: 'Creator-en',
        component: () => import(/* webpackChunkName: "creator" */ '../views/creator-en'),
      },
    ],
  },
];
